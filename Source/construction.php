...
<html lang="en">
  <head>
    ...
    <link href="assets/css/construction.css" rel="stylesheet">
    <title>Kunu</title>
  </head>
  <body>
    <!-- Navigation -->
    ...
    <nav class="navbar navbar-expand-xl navbar-light bg-light">
         <a class="navbar-brand" href="#" onclick="window.location.reload();">N</a>
        ...
        <div class="masthead text-center text-white">
         <div class="masthead-content">
           <div class="container">
             <h1 class="masthead-heading mb-0">En Construction</h1>
             <h2 class="masthead-subheading mb-0" id="subheading">Cette partie du site est actuellement indisponible</h2>
            </div>
           </div>
         </div>
