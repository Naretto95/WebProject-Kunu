     ...
     <div class="container" id="main">
         ...
         <div class="col-lg-12">
           ...
           <div class="carousel-item active">
                <img class="card-img-top img-fluid" src="assets/css/images/Item1/item32.jpg" alt="First slide">
               </div>
           <div class="carousel-item">
                <img class="card-img-top img-fluid" src="assets/css/images/Item1/item12.jpg" alt="">
               </div>
           <div class="carousel-item">
               <img class="d-block w-100" src="assets/css/images/Item1/item42.jpg" alt="Third slide">
               </div>
           <div class="carousel-item">
               <img class="d-block w-100" src="assets/css/images/Item1/item22.jpg" alt="Fourth slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="assets/css/images/Item1/item62.jpg" alt="Fifth slide">
             </div>
          </div>
            ...
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
             ...
             <div class="card-body">
               <h3 class="card-title">Manteau Fashion</h3>
               <h4>99.99€</h4>
               <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente dicta fugit fugiat hic aliquam itaque facere, soluta. Totam id dolores, sint aperiam sequi pariatur praesentium animi perspiciatis molestias iure, ducimus!</p>
               <span class="text-warning">&#9733; &#9733; &#9733; &#9733; &#9734;</span>
               4.0 étoiles  <a href="addtocart.php?id=1" class="btn btn-primary">Ajouter au Panier</a>
             </div>
           </div>
           <!-- /.card -->
