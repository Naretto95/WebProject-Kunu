...
<!-- Navigation -->
     <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      ...
      <!-- Page Content -->
      <header >
        <div class="container h-100" id="cont">
          <div class="row h-100 align-items-center">
            <div class="col-lg-12">
              <h1 class="display-4 text-white mt-5 mb-2">Dates et Lieux</strong> </h1>
      ...
      <div class="container" id="cont2">
        <figure class="snip1573">
          <img src="assets/css/images/calendar3.png" alt="sample89" />
          <figcaption>
            <h3>Calendrier</h3>
          </figcaption>
          <a href="calendrier.php"></a>
        </figure>
        <figure class="snip1573"><img src="assets/css/images/map3.png" alt="sample94" />
          <figcaption>
            <h3>Carte</h3>
          </figcaption>
          <a href="carte.php"></a>
